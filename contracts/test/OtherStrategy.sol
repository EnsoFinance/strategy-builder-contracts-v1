...
import "./OtherStrategyCommon.sol";
import "./OtherStrategyFees.sol";
 ...
 */
contract Strategy is IStrategy, IStrategyManagement, OtherStrategyToken, OtherStrategyCommon, OtherStrategyFees, Initializable, Timelocks {
    ...
    constructor(address factory_, address controller_, address synthetixResolver_, address aaveResolver_) public initializer OtherStrategyCommon(factory_, controller_) {
