...
var Tokens = /** @class */ (function () {
    ...
    Tokens.prototype.registerTokens = function (owner, strategyFactory, curvePoolRegistry, chainlinkOracle) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            ...
                            strategyFactory.connect(owner).addItemToRegistry(utils_1.ITEM_CATEGORY.BASIC, utils_1.ESTIMATOR_CATEGORY.SYNTH, this.knc),
                            ...
                            strategyFactory.connect(owner).addItemToRegistry(utils_1.ITEM_CATEGORY.SYNTH, utils_1.ESTIMATOR_CATEGORY.SYNTH, this.sETH),
                            strategyFactory.connect(owner).addItemToRegistry(utils_1.ITEM_CATEGORY.SYNTH, utils_1.ESTIMATOR_CATEGORY.SYNTH, this.sAAVE),
                            strategyFactory.connect(owner).addItemToRegistry(utils_1.ITEM_CATEGORY.SYNTH, utils_1.ESTIMATOR_CATEGORY.SYNTH, this.sBTC),
                            strategyFactory.connect(owner).addItemToRegistry(utils_1.ITEM_CATEGORY.SYNTH, utils_1.ESTIMATOR_CATEGORY.SYNTH, this.sDOT),
                            strategyFactory.connect(owner).addItemToRegistry(utils_1.ITEM_CATEGORY.SYNTH, utils_1.ESTIMATOR_CATEGORY.SYNTH, this.sADA),
                    ...
                    case 1:
                        _a.sent();
                        if (!curvePoolRegistry) return [3 /*break*/, 9];
                        return [4 /*yield*/, curvePoolRegistry.connect(owner).addPool(this.crv3, '0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7', '0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7', this.crv3Gauge, false)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, curvePoolRegistry.connect(owner).addPool(this.crvSUSD, '0xfcba3e75865d2d561be8d220616520c171f12851', '0xA5407eAE9Ba41422680e2e00537571bcC53efBfD', this.crvSUSDGauge, true)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, curvePoolRegistry.connect(owner).addPool(this.crvAAVE, '0xDeBF20617708857ebe4F679508E7b7863a8A8EeE', '0xDeBF20617708857ebe4F679508E7b7863a8A8EeE', this.crvAAVEGauge, false)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, curvePoolRegistry.connect(owner).addPool(this.crvSAAVE, '0xEB16Ae0052ed37f479f7fe63849198Df1765a733', '0xEB16Ae0052ed37f479f7fe63849198Df1765a733', this.crvSAAVEGauge, false)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, curvePoolRegistry.connect(owner).addPool(this.crvLINK, '0xf178c0b5bb7e7abf4e12a4838c7b7c5ba2c623c0', '0xf178c0b5bb7e7abf4e12a4838c7b7c5ba2c623c0', this.crvLINKGauge, false)];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, curvePoolRegistry.connect(owner).addPool(this.crvUSDP, '0x3c8cAee4E09296800f8D29A68Fa3837e2dae4940', '0x42d7025938bEc20B69cBae5A77421082407f053A', this.crvUSDPGauge, false)];
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, curvePoolRegistry.connect(owner).addPool(this.crvCOMP, '0xeb21209ae4c2c9ff2a86aca31e123764a3b6bc06', '0xA2B47E3D5c44877cca798226B7B8118F9BFb7A56', this.crvCOMPGauge, true)];
                    case 8:
                        _a.sent();
                        _a.label = 9;
                    case 9:
                        if (!chainlinkOracle) return [3 /*break*/, 19];
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sUSD, this.weth, '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419', true)];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sEUR, this.sUSD, '0xb49f677943BC038e9857d61E7d053CaA2C1734C1', false)];
                    case 11:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sLINK, this.weth, '0xDC530D9457755926550b59e8ECcdaE7624181557', false)];
                    case 12:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.knc, this.sUSD, '0xf8ff43e991a81e6ec886a3d281a2c6cc19ae70fc', false)];
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sETH, this.sUSD, '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419', false)];
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sAAVE, this.weth, '0x6df09e975c830ecae5bd4ed9d90f3a95a4f88012', false)];
                    case 15:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sBTC, this.weth, '0xdeb288f737066589598e9214e782fa5a8ed689e8', false)];
                    case 16:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sDOT, this.sUSD, '0x1c07afb8e2b827c5a4739c6d59ae3a5035f28734', false)];
                    case 17:
                        _a.sent();
                        return [4 /*yield*/, chainlinkOracle.connect(owner).addOracle(this.sADA, this.sUSD, '0xae48c91df1fe419994ffda27da09d5ac69c30f55', false)];
                    case 18:
                        _a.sent();
                        _a.label = 19;
