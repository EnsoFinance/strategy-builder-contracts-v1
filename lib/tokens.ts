...
export class Tokens {
	...
	async registerTokens(
		...
		await Promise.all([
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.RESERVE, ESTIMATOR_CATEGORY.DEFAULT_ORACLE, this.weth),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.RESERVE, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.sUSD),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.knc),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.cream),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.SYNTH, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.sEUR),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.SYNTH, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.sLINK),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.SYNTH, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.sETH),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.SYNTH, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.sAAVE),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.SYNTH, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.sBTC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.SYNTH, ESTIMATOR_CATEGORY.CHAINLINK_ORACLE, this.sDOT),
			strategyFactory
				.connect(owner)
			...
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.AAVE_V2, this.aWBTC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.AAVE_V2, this.aDAI),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.AAVE_V2, this.aUSDC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.AAVE_V2, this.aUSDT),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.AAVE_V2, this.aCRV),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.DEBT, ESTIMATOR_CATEGORY.AAVE_V2_DEBT, this.debtDAI),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.DEBT, ESTIMATOR_CATEGORY.AAVE_V2_DEBT, this.debtUSDC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.DEBT, ESTIMATOR_CATEGORY.AAVE_V2_DEBT, this.debtWBTC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.DEBT, ESTIMATOR_CATEGORY.AAVE_V2_DEBT, this.debtWETH),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.COMPOUND, this.cDAI),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.COMPOUND, this.cUSDC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.COMPOUND, this.cUSDT),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.DEFAULT_ORACLE, this.COMP),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crv3),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvTriCrypto2),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvUSDP),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvSUSD),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvAAVE),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvSAAVE),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvLINK),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvCOMP),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvUSDN),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvSETH),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_LP, this.crvREN),
			strategyFactory
				.connect(owner)
			...
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_GAUGE, this.crvAAVEGauge),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_GAUGE, this.crvSAAVEGauge),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_GAUGE, this.crvCOMPGauge),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.CURVE_GAUGE, this.crvLINKGauge),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.YEARN_V2, this.ycrv3),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.YEARN_V2, this.ycrvTriCrypto2),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.YEARN_V2, this.ycrvUSDP),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.YEARN_V2, this.ycrvSUSD),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.YEARN_V2, this.yDAI),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.YEARN_V2, this.yUSDC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.YEARN_V2, this.yWBTC),
			strategyFactory
				.connect(owner)
				.addItemToRegistry(ITEM_CATEGORY.BASIC, ESTIMATOR_CATEGORY.BLOCKED, this.crvTriCrypto), // Depreciated for TriCrypto2
			strategyFactory
				.connect(owner)
				.addItemToRegistry(
					ITEM_CATEGORY.BASIC,
		...
		if (chainlinkRegistry) {
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sUSD, this.weth, '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419', true)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sEUR, this.sUSD, '0xb49f677943BC038e9857d61E7d053CaA2C1734C1', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sLINK, this.weth, '0xDC530D9457755926550b59e8ECcdaE7624181557', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.knc, this.sUSD, '0xf8ff43e991a81e6ec886a3d281a2c6cc19ae70fc', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sETH, this.sUSD, '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sAAVE, this.weth, '0x6df09e975c830ecae5bd4ed9d90f3a95a4f88012', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sBTC, this.weth, '0xdeb288f737066589598e9214e782fa5a8ed689e8', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sDOT, this.sUSD, '0x1c07afb8e2b827c5a4739c6d59ae3a5035f28734', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.sADA, this.sUSD, '0xae48c91df1fe419994ffda27da09d5ac69c30f55', false)
			await chainlinkRegistry
				.connect(owner)
				.addOracle(this.cream, this.weth, '0x82597cfe6af8baad7c0d441aa82cbc3b51759607', false)
		}
		if (curveDepositZapRegistry) {
			await curveDepositZapRegistry
				.connect(owner)
				.addZap(this.crvSUSD, '0xfcba3e75865d2d561be8d220616520c171f12851', 0)
			await curveDepositZapRegistry
				.connect(owner)
				.addZap(this.crvUSDP, '0x3c8cAee4E09296800f8D29A68Fa3837e2dae4940', 0)
			await curveDepositZapRegistry
				.connect(owner)
				.addZap(this.crvCOMP, '0xeb21209ae4c2c9ff2a86aca31e123764a3b6bc06', 0)
			await curveDepositZapRegistry
				.connect(owner)
				.addZap(this.crvTriCrypto2, '0xD51a44d3FaE010294C616388b506AcdA1bfAAE46', 1)
		}
	}
}
